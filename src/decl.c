...
for (size_t i=0;i<vectorSize(stNameSpace);i++)
{
            ...
            // decl  :    viene salvato il nodo con le informazioni per la successiva sostituzione con al COSTANTE
            // expr  :    viene valutato nell'espresione e ritornato un nodo COSTANTE
